# -*- coding: utf-8 -*-
"""
Created on Tue May 18 17:31:13 2021
...
class MiniImagenetDataset(data.Dataset):
    def __init__(self, mode='train', root='./data/mini-imagenet', transform=None, target_transform=None, split=False):
        '''
        ...
        print('Number of samples: %d' % len(self.x))
